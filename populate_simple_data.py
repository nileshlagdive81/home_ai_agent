#!/usr/bin/env python3
"""
Simple script to populate database with basic data for Pune and Mumbai
"""
...
def populate_simple_data():
    ...
    print("🌱 Populating Database with Basic Data...")
    print("=" * 60)
            ...
            for loc_data in locations:
                for i in range(2):  # 2 projects per location
                    ...
                    project = Project(
                        id=str(uuid.uuid4()),
                        name=project_name,
                        developer_id=None,  # Set to NULL since developers table doesn't exist
