...
def populate_fresh_data():
    ...
    try:
        ...
        for amenity_data in amenities_data:
            ...
            # Explicitly set timestamps
            amenity.created_at = current_time
            amenity.updated_at = current_time
        ...
        for place_data in nearby_places_data:
            ...
            # Explicitly set timestamps
            place.created_at = current_time
            place.updated_at = current_time
        ...
        for dev_name in developers_data:
            ...
            # Explicitly set timestamps
            developer.created_at = current_time
            developer.updated_at = current_time
            ...
            for loc_data in locations:
                for i in range(2):  # 2 projects per location
                    ...
                    project = Project(
                        ...
                        possession_date=current_time + timedelta(days=random.randint(100, 800)),
                        completion_date=current_time + timedelta(days=random.randint(50, 400))
                    )
                    # Explicitly set timestamps
                    ...
                    for amenity in project_amenities:
                        ...
                        # Explicitly set timestamps
                        project_amenity.created_at = current_time
                        project_amenity.updated_at = current_time
                    ...
                    for nearby in project_nearby:
                        ...
                        # Explicitly set timestamps
                        project_nearby_rel.created_at = current_time
                        project_nearby_rel.updated_at = current_time
